...
export const TaxTable = ({
  ...
  const theme = {
    blue: {
      ...
      thead: "bg-slate-50 dark:bg-slate-700 text-slate-600 dark:text-slate-200",
      rowHover: "hover:bg-slate-50/80 dark:hover:bg-slate-700/50",
      accentText: "text-blue-600 dark:text-blue-400",
    },
    pink: {
      border: "border-pink-100 dark:border-pink-900/30",
      thead: "bg-pink-50 dark:bg-pink-900/20 text-slate-600 dark:text-pink-200",
  ...
  return (
    <div
      className={`overflow-x-auto border rounded-xl shadow-sm bg-white dark:bg-slate-800 ${theme.border}`}
    >
